...
public class MyLog {
    ...
    private static final String POINTCUT_METHOD   = "execution(@com.goorwl.mylog.DebugLog * *(..))";
    private static final String POINTCUT_CONSCTUT = "execution(@com.goorwl.mylog.DebugLog *.new(..))";
